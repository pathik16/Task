...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM `Task_2` WHERE `id`='$ids'";
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-8">
                    ...
                    <select class="form-select" aria-label="Default select example" name="std_id">
                        <option selected>select Standard Id From List</option>
                        <?php
                    $query1 = "SELECT * FROM `Standard`";
                    $result1 = mysqli_query($connection,$query1);
                    while($row = mysqli_fetch_array($result1)){
                        echo"<option value=" . $row['id'] ." name=".$row['id'].">".$row['std_name']."</option>";
                    }
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block btn-lg" name="updatestudent">Update</button>
            </div>
        </form>
...
if (isset($_POST["updatestudent"])) {
    ...
    $query1 = "UPDATE `Task_2` SET `username`='$username',`city`='$city',`contact_no`='$contact_no',`email`='$email',`password`='$password', `std_id`='$id' WHERE id='$ids'";
