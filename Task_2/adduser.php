    ...
    <div class="signup-form">
        <form action="adduser.php" method="post" enctype="multipart/form-data">
            <div class="form-header">
                <h2>Enter Details</h2>
                <p>You need to provide your details here.</p>
            </div>
            ...
            <div class="form-group">
				<div class="col-8">
                    ...
                    echo"<option value=" . $row['access_type'] ." name=".$row['access_type'].">".$row['access_type']."</option>";
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="int" class="form-control" name="contact_no" required="required">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block btn-lg" name="adduser">Add User</button>
                <?php
                adduser();
                ?>
            </div>
