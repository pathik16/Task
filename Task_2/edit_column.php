...
if (isset($_FILES['image'])) {
    ...
    $file_a = strtolower(end(explode('.', $_FILES['image']['name'])));
    $newfilename = $name . "_" . $id . "." . $file_a;
    $path = "../Task_2/image/" . $newfilename;
...
if (isset($_POST["update"])) {
    ...
    $query1 = "UPDATE `Task_2` SET `username`='$username',`city`='$city',`contact_no`='$contact_no',`email`='$email',`password`='$password', `image`='$newfilename' WHERE id='$id'";
...
<body>
    <div class="signup-form">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Image</label>
                <input type="file" class="form-control" name="image" value="Enter Your Image" accept=".png, .jpg, .jpeg">
            </div>
            <div class="form-group">
